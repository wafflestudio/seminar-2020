...
- 배포에 성공했다면, 웹 브라우저를 통해 해당 EC2 instance의 Public IPv4 address나 Public IPv4 DNS로 접근하여, DRF가 만들어주는 프론트 화면이 잘 보이는지 확인하세요.
...
- 기본적으로 [가비아(Gabia)](https://www.gabia.com)를 이용하는 것으로 하겠습니다. 계정이 없으면 가입해주세요. 
